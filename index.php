...
<body>
	<div class="container">
		...
		<div class="rss">
			...
			?>
			<div class="container">
				<a href="https://weather.yahoo.co.jp/weather/" target="_blank"><img class="icon" src="icon/yahoo_ten.png"></a>
				<div class="con_link">
		...
		<div class="rss">
			...
			?>
			<div class="container">
				<a href="https://www.lifehacker.jp/" target="_blank"><img class="icon" src="icon/life_hack.png"></a>
				<div class="con_link">
					<p><a href="<?php echo $data[0]['link']; ?>" target="_blank"> <?php echo $data[0]['title']; ?></a></p>
				</div>
					<p><?php echo $data[0]['description']; ?></p>
